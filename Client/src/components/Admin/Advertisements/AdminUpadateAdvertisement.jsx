...
const AdminUpdateAdvertisements = () => {
  const { id } = useParams();
    ...
    try {
      ...
      setFormData({
        ...
        publishedDate: data.publishedDate
          ...
          : "",
        unpublishedDate: data.unpublishedDate
          ? new Date(data.unpublishedDate).toISOString().split("T")[0]
          : "",
        image: null,
      ...
      toast.error(
        error.response?.data?.message ||
          "Failed to fetch advertisement details."
      );
    } finally {
      setFetching(false);
    }
...
export default AdminUpdateAdvertisements;
