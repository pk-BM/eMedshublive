    ...
    <div className="w-full min-h-screen">
      ...
      <div className="relative w-full min-h-[30rem] border-y-4 border-tertiary flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <motion.div
            className="relative flex items-center justify-center w-full max-w-xs md:max-w-xl"
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            {showDropdown && filteredGenerics.length > 0 && (
              <ul className="absolute top-full left-0 w-full bg-white shadow-lg border rounded-md mt-1 max-h-56 overflow-y-auto z-50">
            ...
            {/* No results */}
            {showDropdown && filteredGenerics.length === 0 && (
              <div className="absolute top-full left-0 w-full bg-white border rounded-md mt-1 shadow-lg z-50 p-3 text-gray-500">
                No results found
              </div>
            )}
          </motion.div>
