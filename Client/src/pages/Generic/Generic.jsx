    ...
    <div className="min-h-screen bg-gray-50 px-5 py-10 font-inter">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-4 border-b-2 border-green-200 pb-4">
        <h2 className="text-2xl font-semibold text-slate-800 flex items-center gap-2">
          ...
          <span className="tracking-wide">Generics</span>
        </h2>
            ...
            return (
              <Link key={index} to={`/generics/${generic._id}`} className="block">
                <div className="group flex flex-col justify-center items-center bg-white border border-green-200 rounded-xl w-full h-40 transition-all duration-300 cursor-pointer hover:bg-[#34d399] hover:shadow-lg">
                  ...
                  <span className="text-lg font-semibold text-slate-800 leading-snug text-center transition-colors duration-300 group-hover:text-white">
                    {generic.name}
                  </span>
                </div>
              </Link>
